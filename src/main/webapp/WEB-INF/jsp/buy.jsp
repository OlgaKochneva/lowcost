    ...
    <div class="row ">
        <div class="col-md-12 mainContentBuy">
            <form action="<%=Endpoints.TICKETS + Endpoints.ADD%>" method="post">
                ...
                <br/>
                <spring:message code="lang.isBusiness"/>: <input type="checkbox" id="isBusiness" value="true"
                                                                 name="isBusiness"
                                                                 onclick="updatePrice()"/>
                + <c:out value="${flight.businessPrice}"/> <br/>
                <spring:message code="lang.hasLuggage"/>: <input type="checkbox" id="hasLuggage" name="hasLuggage"
                                                                 value="true"
                                                                 onclick="updatePrice()"/>+ <c:out
                    value="${flight.placePriorityPrice}"/><br/>
                <spring:message code="lang.placePriority"/>: <input type="checkbox" id="placePriority"
                                                                    name="placePriority"
                                                                    value="true"
                                                                    onclick="updatePrice()"/> + <c:out
