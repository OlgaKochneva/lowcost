...
<div align="right" class="language" >
    ...
    <div class="topnav">
        ...
        <sec:authorize access="hasRole('ROLE_ADMIN')"> |<a href="<%=Endpoints.USER + Endpoints.ALL%>" class="navbarLink"> <spring:message code="lang.allUsers"/></a>|</sec:authorize>
        ...
        <sec:authorize access="hasRole('ROLE_ADMIN')"> <a href="<%=Endpoints.TICKETS + Endpoints.ALL %>" class="navbarLink"> <spring:message code="lang.tickets"/></a>|</sec:authorize>
