    ...
    <div class="row">
        ...
        <div class="col-md-3 mainContentUpdate">
            ...
            <form action="<%=Endpoints.FLIGHTS + Endpoints.UPDATE%>" method="post">
                ...
                <spring:message code="lang.departureAt"/><br/><input type="text" required name="departureDate"
                                                                     class="form-control input"
                                                                     value="${flight.departureDate}"/>
                <spring:message code="lang.arriveAt"/>. <br/> <input type="text" required name="arrivalDate"
                                                                     class="form-control input"
